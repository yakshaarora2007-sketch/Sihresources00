...
export const PlaybackControls: React.FC<PlaybackControlsProps> = ({
  ...
  return (
    <div className="bg-slate-900/90 border-t border-slate-800 px-7 py-4 flex flex-col gap-3 backdrop-blur-lg select-none">
      {/* Frame Scrubber Bar */}
      <div className="flex items-center gap-5">
        <span className="text-sm font-mono text-emerald-400 font-semibold min-w-28">
        ...
        <div className="relative flex-1 flex items-center group">
          <input
            ...
            className="w-full h-2.5 bg-slate-800 rounded-lg appearance-none cursor-pointer accent-emerald-400 focus:outline-none transition-all"
            style={{
        ...
        <span className="text-sm font-mono text-slate-400 min-w-16 text-right">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className={`flex items-center justify-center w-11 h-11 rounded-full font-bold transition shadow-lg ${
              isPlaying
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-slate-400 mr-1">Target Speed:</span>
          <div className="flex bg-slate-800 rounded-lg p-0.5 border border-slate-700/60">
            {SPEED_OPTIONS.map((fps) => (
              <button
                ...
                className={`px-3 py-1.5 text-sm font-mono font-medium rounded-md transition ${
                  targetFps === fps
